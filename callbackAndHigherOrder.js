...
// const first = (arr, callback) => callback(arr[0]) ARROW NOTATION
...
const contains = (arr, person, callback) => {
...
const checkArray = (uniqueArr) => {
 console.log('The new names array with all the duplicate items removed is [UNIQARRPARAM].', uniqueArr)
}
...
const getUserById = (arrayOfObj, id, callback) => {
  // if (arrayOfObj.id == id){
    callback(arrayOfObj)
